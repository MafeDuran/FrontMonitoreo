...
const PorMonitoreo = () => {
  const [activeTab, setActiveTab] = useState('por_monitoreo');
      ...
      <div className="header">
        ...
        <div className="tabs-datos">
          <button
            ...
            onClick={() => showTab('por_monitoreo')}
          >
            Por Monitoreo
          </button>
          <button
            className={activeTab === 'plan_de_accion' ? 'active' : ''}
            onClick={() => showonchange('plan_de_accion')}
          >
            Plan de acción
          </button>
