...
const ProgramacionSemanal = () => {
  const [activeTab, setActiveTab] = useState('programacion_semanal');
  ...
  return (
    <div>
      ...
      <div className="header">
        <div className="tabs-datos">
          ...
          <button
            ...
            onClick={() => showTab('programacion_semanal')}
          >
            Progr. Semanal
          </button>
        </div>
      ...
      {activeTab === 'programacion_semanal' && (
         ...
         <div className="card smaller-card">
            <div className="card-body">
                ...
                <div className="col-4 ms-4">
                    ...
                    <div className="mb-3">
                        <div className="d-flex align-items-center">
                            <label htmlFor="vigenciaSelect2" className="form-label fw-bold" style={{ width: '125px' }}>Agrupar</label>
                            <select className="form-select" id="vigenciaSelect2">
                            <option value="">Seleccione</option>
                            <option value="si">Sí</option>
                            <option value="no">No</option>
                ...
                <div className="col-4">
                    ...
                    <div className="mb-3">
                        <div className="d-flex align-items-center">
                            <label htmlFor="vigenciaSelect5" className="form-label fw-bold" style={{ width: '70px' }}>Cumplimiento</label>
                            <select className="form-select" id="vigenciaSelect5">
                            <option value="">Seleccione</option>
                            <option value="si">Sí</option>
                            <option value="no">No</option>
