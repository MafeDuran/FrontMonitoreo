...
const InformeDetalleSemanal = () => {
  const [activeTab, setActiveTab] = useState('inf_detalle_semanal');
      ...
      <div className="header">
        <div className="tabs-datos">
          ...
          <button
            ...
            onClick={() => showTab('inf_detalle_semanal')}
          >
            Inf Detalle Semanal
          </button>
          <button
         ...
         <div className="card smaller-card">
            <div className="card-body">
                ...
                <div className="col-4 ms-4">
                    ...
                    <div className="mb-3">
                    <div className="d-flex align-items-center">
                        <label htmlFor="vigenciaSelect3" className="form-label fw-bold" style={{ width: '125px' }}>Agrupar</label>
...
export default InformeDetalleSemanal;
